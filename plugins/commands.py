...
from info import CHANNELS, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, REQST_CHANNEL, SUPPORT_CHAT_ID
...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🤖 𝚄𝚙𝚍𝚊𝚝𝚎𝚜', url='https://t.me/Teammas_Link')
            ],
            [
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🤖 Join Updates Channel", url=https://t.me/+83woucFZ9Ec4MWU1
                )
            ]
        ]
